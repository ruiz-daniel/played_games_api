...
-- ----------------------------
INSERT INTO `playedgame` VALUES ('02e521f8-6d49-403d-8040-ff509f74527d', 'Saints Row Gat Out of Hell', '2015', 'Volition', 'Deep Silver', 'Open World Action', 5, 1, 5, 'https://localhost:5001/game_images/Saints Row Gat Out of Hell.jpg');
INSERT INTO `playedgame` VALUES ('02ef03d4-bb30-4f4b-8031-fe42e5f10238', 'Call of Duty WWII', '2017', 'Sledgehammer', 'Activision', 'First Person Shooter', 7, 1, 1, 'https://localhost:5001/game_images/Call of Duty WWII.jpg');
...
INSERT INTO `playedgame` VALUES ('08cb1b15-2ddd-4a43-b023-8d38b76a5797', 'Kirby Mass Attack', '2011', 'HAL Laboratory', 'Nintendo', 'Platform Action Adventure', 9, 8, 1, 'https://localhost:5001/game_images/Kirby Mass Attack.jpg');
INSERT INTO `playedgame` VALUES ('0aa5683e-47d2-48fe-a0cd-1c6582ff6edc', 'Super Smash Bros Ultimate', '2018', 'Sora Ltd. Nintendo', 'Nintendo', 'Platform Fighter', 8, 11, 2, 'https://localhost:5001/game_images/Super Smash Bros Ultimate.jpg');
INSERT INTO `playedgame` VALUES ('0b071dd8-deda-415b-950b-aaa407856701', 'Nascar Heat', '2000', 'Monster Games', 'Hasbro Interactive', 'Racing', 4, 2, 2, 'https://localhost:5001/game_images/Nascar Heat.jpg');
...
INSERT INTO `playedgame` VALUES ('1aec268c-11ae-4f40-9d5b-049d700ab000', 'Nioh 2', '2020', 'Team Ninja', 'Koei Tecmo', 'Action RPG', 10, 1, 3, 'https://localhost:5001/game_images/Nioh 2.jpg');
...
INSERT INTO `playedgame` VALUES ('1fd77937-6279-42dc-9009-2d7ad489f265', 'Cuphead', '2017', 'Studio MDHR', 'Studio MDHR', '2D Platform Shooter', 8, 1, 5, 'https://localhost:5001/game_images/Cuphead.jpg');
...
INSERT INTO `playedgame` VALUES ('2ed85464-ddbe-40f2-b3a7-c3232fc853c0', 'X-Men Mutant Academy 2', '2001', 'Midway Studios', 'Sony, Activision', 'Fighting', 8, 2, 2, 'https://localhost:5001/game_images/X-Men Mutant Academy 2.jpg');
INSERT INTO `playedgame` VALUES ('308e2e29-c4bc-463d-8e85-67c455db4dd2', 'Firewatch', '2016', 'Camposanto', 'Panic, Camposanto', 'Interactive Novel', 8, 1, 1, 'https://localhost:5001/game_images/Firewatch.jpg');
INSERT INTO `playedgame` VALUES ('3142455a-c2f5-4df1-ab73-0832f3c2c38c', 'Tales of Vesperia Definitive Edition', '2019', 'Namco Tales Studio', 'Bandai Namco', 'Action JRPG', 9, 1, 1, 'https://localhost:5001/game_images/Tales of Vesperia Definitive Edition.jpg');
INSERT INTO `playedgame` VALUES ('32d41503-ea94-41f0-b867-75b26af2e28f', 'FIFA 14', '2013', 'EA Sports', 'Electronic Arts', 'Sports/Football', 7, 1, 2, 'https://localhost:5001/game_images/FIFA 14.jpg');
INSERT INTO `playedgame` VALUES ('32eb197b-3e08-44c9-9a18-620f59903da8', 'Call of Duty Modern Warfare 3', '2011', 'Infinite Wards', 'Activision', 'First Person Shooter', 5, 1, 1, 'https://localhost:5001/game_images/Call of Duty Modern Warfare 3.jpg');
...
INSERT INTO `playedgame` VALUES ('4061c455-bbc3-41e3-9d81-db0293989216', 'Super Smash Bros Brawl', '2008', 'Sora Ltd, Nintendo', 'Nintendo', 'Platform Fighter', 4, 13, 2, 'https://localhost:5001/game_images/Super Smash Bros Brawl.jpg');
INSERT INTO `playedgame` VALUES ('43020cc7-61cd-43d1-b3d3-c8d6b1cfc39e', 'Spiderman 2 Enter Electro', '2001', 'Vicarious Visions', 'Activision', 'Action Adventure', 7, 2, 5, 'https://localhost:5001/game_images/Spiderman 2 Enter Electro.jpg');
INSERT INTO `playedgame` VALUES ('43787106-c057-4494-819a-bd65d6caf521', 'Dota 2', '2013', 'Valve', 'Valve', 'MOBA', 7, 1, 2, 'https://localhost:5001/game_images/Dota 2.jpg');
INSERT INTO `playedgame` VALUES ('43d0600f-8322-49ac-8917-b8473ff3c2c7', 'Dead Or Alive 6', '2019', 'Team Ninja', 'Koei Tecmo', 'Fighting', 6, 1, 2, 'https://localhost:5001/game_images/Dead Or Alive 6.jpg');
INSERT INTO `playedgame` VALUES ('4411349d-6b13-4573-9318-76bef6575f17', 'Rivals of Aether', '2017', 'Dan Fornace', 'Dan Fornace', 'Platform Fighter', 9, 1, 2, 'https://localhost:5001/game_images/Rivals of Aether.jpg');
INSERT INTO `playedgame` VALUES ('4421e818-7a2b-41a1-bf9a-6fa1854d2aed', 'Pokémon Ranger Shadows of Almia', '2008', 'HAL Laboratory', 'Nintendo', 'Adventure RPG', 7, 8, 5, 'https://localhost:5001/game_images/Pokémon Ranger Shadows of Almia.jpg');
INSERT INTO `playedgame` VALUES ('4493ccb1-a182-43bd-b316-96a5d8b3ddd6', 'RWBY Grimn Eclipse', '2016', 'Rooster Teeth Games', 'Rooster Teeth', 'Action Adventure', 3, 1, 5, 'https://localhost:5001/game_images/RWBY Grimn Eclipse.jpg');
INSERT INTO `playedgame` VALUES ('45246225-7a3d-4ef6-a11f-18d6a3948037', 'Assassin\'s Creed IV Black Flag', '2013', 'Ubisoft', 'Ubisoft', 'Open World Action Adventure', 6, 1, 5, 'https://localhost:5001/game_images/Assassin\'s Creed IV Black Flag.jpg');
INSERT INTO `playedgame` VALUES ('4607597d-59c5-4ce1-9a2e-ce6010d83e6d', 'Jump Force', '2019', 'Spike Chunsoft', 'Bandai Namco', 'Arena Fighter', 2, 1, 5, 'https://localhost:5001/game_images/Jump Force.jpg');
INSERT INTO `playedgame` VALUES ('47994d70-4ee8-4968-8db1-8fea721771d2', 'Shovel Knight', '2014', 'Yacht Club Games', 'Yacht Club Games', 'Platform Action Adventure', 8, 1, 5, 'https://localhost:5001/game_images/Shovel Knight.jpg');
INSERT INTO `playedgame` VALUES ('4a2a3240-4f87-4835-bfd6-2096978abbb2', 'Drakengard 3', '2013', 'Access Games', 'Square Enix', 'Hack\'n Slash / Musou', 9, 4, 1, 'https://localhost:5001/game_images/Drakengard 3.jpg');
INSERT INTO `playedgame` VALUES ('5035439a-9a7d-4705-b21b-6400426f89cb', 'Minecraft', '2009', 'Mojang', 'Microsoft', 'Sandbox', 8, 1, 2, 'https://localhost:5001/game_images/Minecraft.jpg');
INSERT INTO `playedgame` VALUES ('506fc4be-06d3-4bfc-b64d-3dde765a4a92', 'Naruto Shippuden Ultimate Ninja Storm Revolution', '2015', 'CyberConect 2', 'Bandai Namco', 'Arena Fighter', 5, 1, 1, 'https://localhost:5001/game_images/Naruto Shippuden Ultimate Ninja Storm Revolution.jpg');
INSERT INTO `playedgame` VALUES ('50a01c39-5efb-41fc-9101-d8b2fc166e7d', 'Cyberpunk Bartender Action VA-11 Hall-A', '2016', 'Sukeban Games', 'Ysbryd Games', 'Visual Novel', 10, 1, 1, 'https://localhost:5001/game_images/Cyberpunk Bartender Action VA-11 Hall-A.jpg');
INSERT INTO `playedgame` VALUES ('51a23132-99ae-4e91-ad7f-a4d657e83525', 'Dragon Ball Xenoverse', '2015', 'Dimps', 'Bandai Namco', 'Arena Fighter', 6, 1, 1, 'https://localhost:5001/game_images/Dragon Ball Xenoverse.jpg');
INSERT INTO `playedgame` VALUES ('53ff3c14-7493-4544-8a75-19c273674529', 'Undertale', '2015', 'Toby Fox', 'Toby Fox', 'RPG', 10, 1, 1, 'https://localhost:5001/game_images/Undertale.jpg');
INSERT INTO `playedgame` VALUES ('542705f7-98d5-4452-a0fa-5a4c7d4afd8b', 'Magic The Gathering Arena', '2019', 'Wizards of the Coast Games Studio', 'Wizards of the Coast', 'Cards', 9, 1, 2, 'https://localhost:5001/game_images/Magic The Gathering Arena.jpg');
INSERT INTO `playedgame` VALUES ('5555daf6-f8aa-4f2b-b7ba-f01609be307d', 'DiRT Rally', '2015', 'Codemasters', 'Codemasters', 'Racing Simulation', 7, 1, 5, 'https://localhost:5001/game_images/DiRT Rally.jpg');
INSERT INTO `playedgame` VALUES ('55db66ab-f7cd-4e35-8433-b6e7b4b45928', 'Age of Empires II', '1999', 'Esemble Studios, Skybox Labs', 'Microsoft', 'Real Time Strategy', 9, 1, 2, 'https://localhost:5001/game_images/Age of Empires II.jpg');
INSERT INTO `playedgame` VALUES ('56433617-9b22-4ae6-a3b5-ca3c52902010', 'Need For Speed Most Wanted', '2005', 'EA Black Box', 'Electronic Arts', 'Racing', 7, 1, 5, 'https://localhost:5001/game_images/Need For Speed Most Wanted.jpg');
INSERT INTO `playedgame` VALUES ('574654d9-fc23-4b53-b9a0-e5eeff4810c5', 'Digimon Story Cyber Sleuth', '2015', 'Media.Vision', 'Bandai Namco', 'JRPG', 9, 1, 1, 'https://localhost:5001/game_images/Digimon Story Cyber Sleuth.jpg');
INSERT INTO `playedgame` VALUES ('57c55914-9213-4a4e-85ff-880102debf90', 'The King of Fighters XIV', '2013', 'SNK', 'SNK', 'Fighting', 6, 1, 2, 'https://localhost:5001/game_images/The King of Fighters XIV.jpg');
INSERT INTO `playedgame` VALUES ('57f25d10-aeb3-4da4-ad26-4de17119f739', 'Pro Evolution Soccer 2002', '2002', 'Konami', 'Konami', 'Football', 9, 2, 1, 'https://localhost:5001/game_images/Pro Evolution Soccer 2002.jpg');
INSERT INTO `playedgame` VALUES ('57fe9053-ee94-4edc-ac3b-5527ea13bf4e', 'Life is Strange Before the Storm', '2017', 'Dontnold Entertainment', 'Square Enix', 'Interactive Novel', 5, 1, 5, 'https://localhost:5001/game_images/Life is Strange Before the Storm.jpg');
INSERT INTO `playedgame` VALUES ('59194e25-9536-4215-b728-d2327101f14a', 'Final Fantasy VII', '1997', 'Square Enix', 'Square Enix', 'JRPG', 5, 1, 5, 'https://localhost:5001/game_images/Final Fantasy VII.jpg');
INSERT INTO `playedgame` VALUES ('5921e706-f7c0-49b0-b1c7-3b6ae8cb9e0f', 'Funbag Fantasy', '2019', 'Waffle', 'Mangagamer', 'Visual Novel / Hentai', 7, 1, 1, 'https://localhost:5001/game_images/Funbag Fantasy.jpg');
...
INSERT INTO `playedgame` VALUES ('69688e7a-fb83-436b-b8f2-217c468ba356', 'Pro Evolution Soccer 2013', '2012', 'Konami', 'Konami', 'Sports/Football', 8, 1, 1, 'https://localhost:5001/game_images/Pro Evolution Soccer 2013.jpg');
INSERT INTO `playedgame` VALUES ('6c45dc59-f3b6-416d-8b5c-68baf8f94d71', 'Regalia of Men and Monarchs', '2018', 'Pixelated Milk', 'Klabator', 'Tactical RPG', 7, 1, 1, 'https://localhost:5001/game_images/Regalia of Men and Monarchs.jpg');
INSERT INTO `playedgame` VALUES ('6d39bf73-103e-4418-b4d3-337619c78504', 'Dragon Age Origins', '2009', 'Bioware', 'Electronic Arts', 'Action RPG', 6, 1, 5, 'https://localhost:5001/game_images/Dragon Age Origins.jpg');
INSERT INTO `playedgame` VALUES ('6e746f05-c6e3-4be8-b58d-5809a121ec1c', 'Sekiro Shadows Die Twice', '2019', 'From Software', 'Activision', 'Action Adventure / Soulslike', 10, 1, 1, 'https://localhost:5001/game_images/Sekiro Shadows Die Twice.jpg');
INSERT INTO `playedgame` VALUES ('6f0982dd-b22c-4a64-bb6b-1d66ff92e74b', 'Crystar', '2018', 'Gamedrops', 'Spyke Chunsoft', 'Hack\'n Slash', 4, 1, 5, 'https://localhost:5001/game_images/Crystar.jpg');
INSERT INTO `playedgame` VALUES ('710706ac-8216-450b-987c-a0ed06dc7d0c', 'The Witcher 3 Wild Hunt', '2015', 'CD Projekt Red', 'CD Projekt', 'Action RPG', 8, 1, 1, 'https://localhost:5001/game_images/The Witcher 3 Wild Hunt.jpg');
...
INSERT INTO `playedgame` VALUES ('82e66d29-51a2-4112-b450-8899fe15d642', 'Titanfall 2', '2017', 'Respawn Entertainment', 'Electronic Arts', 'First Person Shooter', 9, 1, 1, 'https://localhost:5001/game_images/Titanfall 2.jpg');
INSERT INTO `playedgame` VALUES ('843493b0-225b-4dd3-b535-3ed569ef3059', 'Legends of Runeterra', '2020', 'Riot Games', 'Riot Games', 'Cards', 9, 1, 2, 'https://localhost:5001/game_images/Legends of Runeterra.jpg');
INSERT INTO `playedgame` VALUES ('854ac049-482e-4e29-bcb6-4bdbf34203b3', 'The Witcher 2 Assassins of Kings', '2011', 'CD Projekt Red', 'CD Projekt', 'Action RPG', 9, 1, 1, 'https://localhost:5001/game_images/The Witcher 2 Assassins of Kings.jpg');
INSERT INTO `playedgame` VALUES ('8553db29-0b84-4172-ba4d-fb00ed5b6f6b', 'Crash Team Racing', '1999', 'Naughty Dog', 'Sony', 'Racing', 7, 2, 2, 'https://localhost:5001/game_images/Crash Team Racing.jpg');
INSERT INTO `playedgame` VALUES ('85f6b36d-db09-4692-b13d-41951becf16a', 'Life is Strange', '2015', 'Dontnold Entertainment', 'Square Enix', 'Interactive Novel', 9, 1, 1, 'https://localhost:5001/game_images/Life is Strange.jpg');
INSERT INTO `playedgame` VALUES ('865106fb-c753-49aa-9665-92b83a3ff111', 'Guilty Gear Xrd Rev 2', '2017', 'Arc System Works', 'Arc System Works', 'Fighting', 6, 1, 2, 'https://localhost:5001/game_images/Guilty Gear Xrd Rev 2.jpg');
INSERT INTO `playedgame` VALUES ('86a6fd82-3c53-4f9e-a5a2-10ee1f42ed93', 'Prototype 2', '2012', 'Radical Entertainment', 'Activision', 'Open World Action', 4, 1, 5, 'https://localhost:5001/game_images/Prototype 2.jpg');
INSERT INTO `playedgame` VALUES ('8888f455-083e-4643-b4df-ccfa1968f021', 'Shin Megami Tensei Devil Survivor', '2009', 'ATLUS, Career Soft', 'ATLUS, Nintendo', 'Tactical RPG', 9, 8, 1, 'https://localhost:5001/game_images/Shin Megami Tensei Devil Survivor.jpg');
INSERT INTO `playedgame` VALUES ('893312e5-5770-460d-bddb-fdce94320273', 'Journey', '2012', 'Thatgamecompany', 'Sony', 'Platform Adventure', 10, 1, 1, 'https://localhost:5001/game_images/Journey.jpg');
INSERT INTO `playedgame` VALUES ('896a4b00-4558-49bd-8574-309bc74acc23', 'Tower Hunter Erza\'s Trial', '2019', 'IceSitruuna', 'IceSitruuna', 'Rogue-Like', 7, 1, 2, 'https://localhost:5001/game_images/Tower Hunter Erza\'s Trial.jpg');
INSERT INTO `playedgame` VALUES ('897ea030-772f-445d-8a57-3bd30c7ef01b', 'Digimon Rumble Arena', '2001', 'Bandai, Hudson Soft', 'Bandai, Hudson Soft', 'Platform Fighter', 9, 2, 1, 'https://localhost:5001/game_images/Digimon Rumble Arena.jpg');
INSERT INTO `playedgame` VALUES ('8d243f39-a163-4040-b1e7-121f84fcad75', 'Super Smash Bros 4 WiiU', '2014', 'Sora Ltd. Nintendo', 'Nintendo', 'Platform Fighter', 7, 1, 2, 'https://localhost:5001/game_images/Super Smash Bros 4 WiiU.jpg');
...
INSERT INTO `playedgame` VALUES ('90417cba-7d5d-4c57-9d3d-c72801661a7d', 'Street Fighters V', '2016', 'CAPCOM', 'CAPCOM', 'Fighting', 7, 1, 1, 'https://localhost:5001/game_images/Street Fighters V.jpg');
...
INSERT INTO `playedgame` VALUES ('9419daa4-fa1e-4e34-801d-bf00061e3612', 'The Beginner\'s Guide', '2015', 'Everything Unlimited Ltd', 'Everthing Unlimited Ltd', 'Interactive Novel', 8, 1, 1, 'https://localhost:5001/game_images/The Beginner\'s Guide.jpg');
INSERT INTO `playedgame` VALUES ('968516ae-57f8-486c-b24a-8f269400f10f', 'YuGiOh Forbidden Memories', '2002', 'Konami', 'Konami', 'Cards', 6, 2, 1, 'https://localhost:5001/game_images/YuGiOh Forbidden Memories.jpg');
INSERT INTO `playedgame` VALUES ('97f3de86-4cbe-4061-adab-156af2bd2b81', 'Bayonetta 2', '2014', 'Platinum Games', 'Nintendo', 'Hack\'n Slash', 10, 10, 1, 'https://localhost:5001/game_images/Bayonetta 2.jpg');
INSERT INTO `playedgame` VALUES ('980b0ac5-fbfb-4621-82c8-22b77c8c6958', 'YuGiOh Tag Force', '2006', 'Konami', 'Konami', 'Cards', 7, 12, 1, 'https://localhost:5001/game_images/YuGiOh Tag Force.jpg');
INSERT INTO `playedgame` VALUES ('991fdf9c-43a3-4c85-ab35-bf7e081fe643', 'Metal Gear Rising Revengeance', '2013', 'Platinum Games', 'Konami', 'Hack\'n Slash', 9, 1, 1, 'https://localhost:5001/game_images/Metal Gear Rising Revengeance.jpg');
INSERT INTO `playedgame` VALUES ('993bb0c1-ecf9-4805-b18e-e1d4d4841a83', 'Vanquish', '2013', 'Platinum Games', 'SEGA', '3rd Person Shooter', 6, 1, 5, 'https://localhost:5001/game_images/Vanquish.jpg');
INSERT INTO `playedgame` VALUES ('994ef2a7-8728-4142-9313-50413635dc19', 'Pro Evolution Soccer 2012', '2011', 'Konami', 'Konami', 'Sports/Football', 8, 1, 2, 'https://localhost:5001/game_images/Pro Evolution Soccer 2012.jpg');
INSERT INTO `playedgame` VALUES ('9ae5aa48-bc6f-44c8-9985-24d6a1f175f5', 'Spiderman (2000)', '2000', 'Neversoft', 'Activision', 'Action Adventure', 7, 2, 1, 'https://localhost:5001/game_images/Spiderman (2000).jpg');
INSERT INTO `playedgame` VALUES ('9cd68099-2524-4de5-96ba-a281048ef22b', 'Bleach DS 4th Flame Bringer', '2009', 'Dimps', 'SEGA', 'Side Scrolling Action', 5, 8, 5, 'https://localhost:5001/game_images/Bleach DS 4th Flame Bringer.jpg');
INSERT INTO `playedgame` VALUES ('9d10443c-bc2e-4f2d-a7af-3cf47b752f52', 'Pokémon Diamond', '2006', 'Gamefreak', 'Nintendo', 'JRPG', 7, 8, 1, 'https://localhost:5001/game_images/Pokémon Diamond.jpg');
...
INSERT INTO `playedgame` VALUES ('acfc9b88-1719-405f-ab2b-d300d54298e7', 'Limbo', '2010', 'Playdead', 'Microsoft', 'Side Scrolling Adventure Puzzle', 9, 1, 1, 'https://localhost:5001/game_images/Limbo.jpg');
INSERT INTO `playedgame` VALUES ('aeb9478c-7cfb-4ce3-b248-96765840e9f5', 'FIFA 15', '2014', 'EA Sports', 'Electronic Arts', 'Sports/Football', 8, 1, 2, 'https://localhost:5001/game_images/FIFA 15.jpg');
INSERT INTO `playedgame` VALUES ('af4e3c5a-b437-4d64-82cf-815683910691', 'GRIS', '2018', 'Nomada Studio', 'Devolver Digital', 'Platform', 10, 1, 1, 'https://localhost:5001/game_images/GRIS.jpg');
INSERT INTO `playedgame` VALUES ('b24d4c81-562e-4158-aaeb-2b0c83eae91f', 'Dark Souls 3', '2016', 'From Software', 'Bandai Namco', 'Action RPG / Souls', 8, 1, 5, 'https://localhost:5001/game_images/Dark Souls 3.jpg');
INSERT INTO `playedgame` VALUES ('b2874959-c214-450a-98d9-e65b3ee69791', 'Street Fighter Alpha 3', '1998', 'CAPCOM', 'CAPCOM', 'Fighting', 7, 2, 2, 'https://localhost:5001/game_images/Street Fighter Alpha 3.jpg');
INSERT INTO `playedgame` VALUES ('b312fb15-5a7f-446f-835c-d00a0fef8957', 'Hollow Knight', '2017', 'Team Cherry', 'Team Cherry', 'Metroidvania / Soulslike', 8, 1, 5, 'https://localhost:5001/game_images/Hollow Knight.jpg');
INSERT INTO `playedgame` VALUES ('b320a115-94c2-43da-ac22-0fd6c712992c', 'Megaman ZX Advent', '2007', 'CAPCOM', 'CAPCOM', 'Side Scrolling Action', 8, 8, 1, 'https://localhost:5001/game_images/Megaman ZX Advent.jpg');
INSERT INTO `playedgame` VALUES ('b392cb92-8396-4365-b213-8e433c62761a', 'Dragon Ball FighterZ', '2018', 'Arc System Works', 'Bandai Namco', 'Fighting', 6, 1, 5, 'https://localhost:5001/game_images/Dragon Ball FighterZ.jpg');
...
INSERT INTO `playedgame` VALUES ('b8aec9d6-ebe4-4235-8600-f45df920f6aa', 'Kingdom Hearts 358-2 Days', '2009', 'Square Enix', 'Square Enix', 'Action RPG', 7, 8, 1, 'https://localhost:5001/game_images/Kingdom Hearts 358-2 Days.jpg');
...
INSERT INTO `playedgame` VALUES ('bd359dee-282f-42de-8aa7-7eac28515f0c', 'Metal Slug 3', '2000', 'SNK', 'SNK', 'Side Scrolling Shooter', 8, 2, 1, 'https://localhost:5001/game_images/Metal Slug 3.jpg');
INSERT INTO `playedgame` VALUES ('c039fefe-b656-430a-93ee-20da34d422bb', 'Tony Hawk Pro Skater 2', '2000', 'Neversoft', 'Activision', 'Skate', 7, 2, 2, 'https://localhost:5001/game_images/Tony Hawk Pro Skater 2.jpg');
INSERT INTO `playedgame` VALUES ('c1f01545-181d-4535-b37d-bb28b0c202ea', 'Nioh', '2017', 'Team Ninja', 'Koei Tecmo', 'Action RPG / Soulslike', 10, 1, 1, 'https://localhost:5001/game_images/Nioh.jpg');
INSERT INTO `playedgame` VALUES ('c20f9687-326f-4084-ac6d-bd264d7525a9', 'Night in the Woods', '2017', 'Infinite Fall, Secret Labs', 'Finji', 'Interactive 2D Novel', 8, 1, 1, 'https://localhost:5001/game_images/Night in the Woods.jpg');
...
INSERT INTO `playedgame` VALUES ('d0062c9f-6b90-4a59-9025-3d9894c64a91', 'Tales of Zestiria', '2015', 'Bandai Namco', 'Bandai Namco', 'Action JRPG', 8, 1, 1, 'https://localhost:5001/game_images/Tales of Zestiria.jpg');
INSERT INTO `playedgame` VALUES ('d09d94f0-b7a7-4d5b-8183-92a3326d1096', 'Tomb Rider (2013)', '2013', 'Crystal Dynamics, Eidos Montreal', 'Square Enix', 'Action Adventure', 7, 1, 1, 'https://localhost:5001/game_images/Tomb Rider (2013).jpg');
INSERT INTO `playedgame` VALUES ('d0fb782d-cca9-435b-8470-559ba137e58c', 'Bayonetta', '2009', 'Platinum Games', 'SEGA', 'Hack\'n Slash', 10, 1, 1, 'https://localhost:5001/game_images/Bayonetta.jpg');
INSERT INTO `playedgame` VALUES ('d5104313-8195-4aed-b26b-51518beb2ad8', 'Dead or Alive 5 Last Round', '2012', 'Team Ninja', 'Koei Tecmo', 'Fighting', 6, 1, 2, 'https://localhost:5001/game_images/Dead or Alive 5 Last Round.jpg');
...
INSERT INTO `playedgame` VALUES ('e809665d-b3c9-46f8-8ef5-66ad8cc6b43c', 'Gran Turismo', '1998', 'Polyphony Digital', 'Sony', 'Racing', 9, 2, 1, 'https://localhost:5001/game_images/Gran Turismo.jpg');
INSERT INTO `playedgame` VALUES ('e8465d5d-4cc7-4343-95a3-9d6675a0eb37', 'Tekken 7', '2017', 'Bandai Namco', 'Bandai Namco', 'Fighting', 6, 1, 2, 'https://localhost:5001/game_images/Tekken 7.jpg');
INSERT INTO `playedgame` VALUES ('e875cfe9-b5db-4738-9cc6-29e128579222', 'Assasin\'s Creed Altair Chronicles', '2008', 'Gameloft', 'Ubisoft, Gameloft', 'Side Scrolling Action Adventure', 7, 8, 1, 'https://localhost:5001/game_images/Assasin\'s Creed Altair Chronicles.jpg');
...
INSERT INTO `playedgame` VALUES ('eb594614-4cfc-4944-b9e2-2feaf599bbda', 'Duck Game', '2015', 'Landon Podbielski', 'Adult Swim Games', '2D Platform Shooter', 10, 1, 2, 'https://localhost:5001/game_images/Duck Game.jpg');
...
INSERT INTO `playedgame` VALUES ('f310cf1c-0464-4307-9fa4-18370796c20e', 'Wizard of Legend', '2018', 'Contigent99', 'Humble Bundle', 'Rogue-Like', 9, 1, 2, 'https://localhost:5001/game_images/Wizard of Legend.jpg');
INSERT INTO `playedgame` VALUES ('f393aded-90cf-4448-970b-3724499e9b61', 'Steam World Dig 2', '2017', 'Image & Form', 'Koch Media', '2D Sandbox Adventure', 9, 1, 1, 'https://localhost:5001/game_images/Steam World Dig 2.jpg');
INSERT INTO `playedgame` VALUES ('f5566305-6854-499d-94ca-b6005e4c88da', 'Dark Souls', '2010', 'From Software', 'Bandai Namco', 'Action RPG', 8, 1, 5, 'https://localhost:5001/game_images/Dark Souls.jpg');
...
INSERT INTO `playedgame` VALUES ('fe08d3aa-ccc6-4eba-8435-070bc78c2735', 'Code Vein', '2019', 'Bandai Namco', 'Bandai Namco', 'Action RPG / Soulslike', 8, 1, 5, 'https://localhost:5001/game_images/Code Vein.jpg');
